...
class mainMenu:
    def __init__(self):
        ...
        Label(main_menu, text="Welcome!", font=("arial", 30, "bold"), bg="#70ABAF") \
        ...
        btnbookWedding = Button(main_menu, text="Add wedding Booking", width=30,height=4, bg="medium aquamarine",command=call_wedding_popup)
        btnbookParty = Button(main_menu, text="Add Party Booking", width=30,height=4, bg="medium aquamarine", command=call_party_popup)
        btnbookConference = Button(main_menu, text="Add Conference Booking", width=30,height=4, bg="medium aquamarine",command=call_conference_popup)
        btnviewbookings = Button(main_menu, text="View, edit and delete Bookings", width=30,height=4, bg="medium aquamarine",command=viewbooking.call_viewBookings_popup)
...
class bookwedding:
    ...
    def __init__(self, master):
        ...
        Label(master, text="Book a New Wedding", font=("arial", 20, "bold"), bg="#70ABAF", anchor='center').grid(row=0, columnspan=2, pady=(25, 0), padx=(10, 10))
        Label(master, text="Please fill in all the details below!",font=("arial", 14), fg="blue", bg="#70ABAF").grid(row=1, pady=(25, 0), padx=(30, 10), columnspan=4, sticky=W)

        Label(master, text="Number of guest", font=("arial", 10, "bold"), bg="#70ABAF").grid(row=2, columnspan=2, pady=(25, 0), padx=(10, 10))
        Label(master, text="Name of contact", font=("arial", 10, "bold"), bg="#70ABAF").grid(row=3,columnspan=2,pady=( 25, 0), padx=(10, 10))
        Label(master, text="Address", font=("arial", 10, "bold"), bg="#70ABAF").grid(row=4, columnspan=2,pady=(25, 0),padx=(10, 10))
        Label(master, text="Contact number", font=("arial", 10, "bold"), bg="#70ABAF").grid(row=5, columnspan=2,pady=(25, 0),padx=(10, 10))
        Label(master, text="Event Room Number", font=("arial", 10, "bold"), bg="#70ABAF").grid(row=6,columnspan=2,pady=(25, 0),padx=(10,10))
        Label(master, text="Date of event", font=("arial", 10, "bold"), bg="#70ABAF").grid(row=7,columnspan=2,pady=(25, 0),padx=(10, 10))
        Label(master, text="Band Name", font=("arial", 10, "bold"), bg="#70ABAF").grid(row=8, columnspan=2, pady=(25, 0), padx=(10, 10))
        Label(master, text="Number of bedrooms reserved", font=("arial", 10, "bold"), bg="#70ABAF").grid(row=9, columnspan=2, pady=(25, 0), padx=(10, 10))
        ...
        self.EntnumberOfguest.grid(row=2, column=2, columnspan=2, sticky=W, pady=(15, 0), padx=(0, 25))
        self.EntnameOfContact.grid(row=3, column=2, columnspan=2, pady=(25, 0), padx=(0, 25))
        self.EntAddress.grid(row=4, column=2, columnspan=2, pady=(25, 0), padx=(0, 25))
        self.EntContactNumber.grid(row=5, column=2, columnspan=2, pady=(25, 0), padx=(0, 25))
        self.OpmEventRoomNumber.grid(row=6, column=2, columnspan=2, pady=(25, 0), padx=(0, 25), sticky="ew")
        self.CalDateOfEvent.grid(row=7, column=2, columnspan=2, pady=(25, 0), padx=(0, 25))
        ...
        btnCloseForm = Button(master, text="Cancel",bg="medium aquamarine", width=30,height=3, command=master.destroy)
        btnAddBooking = Button(master, text="Add Booking",bg="medium aquamarine", width=30,height=3,
        ...
        btnAddBooking.grid(row=10, column=1, columnspan=1, pady=(50, 50), padx=(75, 25), sticky="ew")
        btnCloseForm.grid(row=10, column=3, columnspan=2, pady=(50, 50), padx=(25, 75), sticky="ew")
...
class bookConference:
    ...
    def __init__(self, master):
        ...
        #checkbox now works :)
        CheckVar1 = IntVar()
        self.chxProjectorRequired = Checkbutton(master, text='', variable=CheckVar1, onvalue=True, offvalue=False, bg="powder blue", command=ch_box_sel)
